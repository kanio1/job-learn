...
| KAFKA-T19 | 1 | E1 | Lenses env `payment-lab` na overlay; CE bez host 9092 | docs smoke SQL (po E2) | DONE (2026-08-23) |
...
| KAFKA-T10 | 3 | E3 | V37+ `eventlab_processed` (uuidv7, unique group+event_id) | RA-KAFKA-020 | DONE (2026-08-23) |
| KAFKA-T11 | 3 | E3 | Konsument `eventlab-inspector` (flagship PoD ≤5 s) | RA-KAFKA-021…023 | DONE (2026-08-23) |
