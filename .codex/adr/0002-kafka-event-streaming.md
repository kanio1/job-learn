...
5. Konsumenci labowi idempotentni: V37+ `eventlab_processed`, unique `(consumer_group, event_id)`; retry nieblokujące `@RetryableTopic` tylko w eventlab; DLT `lab.event-lab.dlq.v1` (UI: dead-letter topic).
