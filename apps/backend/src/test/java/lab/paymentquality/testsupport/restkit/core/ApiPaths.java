...
public final class ApiPaths {
    ...
    private static final String MERCHANT = MERCHANTS + "/{merchantId}";
    private static final String MERCHANT_ACTIVATION = MERCHANT + "/activate";
    ...
    public static String merchantActivation() {
