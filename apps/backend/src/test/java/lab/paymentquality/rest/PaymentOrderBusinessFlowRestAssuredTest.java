...
@Testcontainers
class PaymentOrderBusinessFlowRestAssuredTest extends PostgresContainerSupport {

    @Container
    static PostgreSQLContainer postgres = newPostgresContainer("payment_order_business_flow_test");
    ...
    void creatorCreatesPaymentOrderAndMerchantReaderReadsIt() {
        ...
        MerchantApiTestSupport.requestWithToken(port, readerToken)
                ...
                .statusCode(200)
                .contentType(ContentType.JSON)
                .header("ETag", startsWith("\"po-" + paymentOrderId + "-v"))
