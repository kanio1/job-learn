...
public record HostedCheckoutSessionResponse(
        ...
        @JsonProperty("simulateToken") String simulateToken,
        @JsonProperty("simulateTokenExpiresAt") Instant simulateTokenExpiresAt
) {
}
