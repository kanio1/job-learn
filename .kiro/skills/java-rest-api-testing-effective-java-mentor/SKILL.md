...
- When a change is architectural or product-oriented, ask whether a Kiro Spec (requirements.md → design.md → tasks.md) is needed before implementation.
...
- `.kilocode/skills/java-rest-api-testing-effective-java-mentor/references/effective-java-sdet-compass.md`
- `.kilocode/skills/java-rest-api-testing-effective-java-mentor/references/rest-assured-spring-test-patterns.md`
- `.kilocode/skills/java-rest-api-testing-effective-java-mentor/references/review-checklist.md`
- `.kilocode/skills/java-rest-api-testing-effective-java-mentor/templates/lesson-template.md`
- `.kilocode/skills/java-rest-api-testing-effective-java-mentor/templates/exercise-template.md`
