...
Before a substantial capability goes to a Kiro Spec, produce:
...
Provide observable, testable, business-oriented acceptance criteria that can seed a Kiro requirements document.
...
Templates: [`references/ba-discovery-pack-template.md`](references/ba-discovery-pack-template.md), [`references/payment-capability-sequencing-guide.md`](references/payment-capability-sequencing-guide.md).
