...
| FR-S04a logout BFF | E2E-021/022/027, UC-01 | existing-pom `/login` + empty `nuxt-session` | P0 |
| FR-S04b logout OIDC | E2E-026, API-024/025, UC-07 | existing-pom | P0 |
| Cookie 4 KB / no id_token | E2E-028 | existing-pom | P0 |
| FR-S02 trzy światy cookies | E2E-024, API-032/033, guest | existing-pom + existing-pom | P0 |
| FR-S03 idle | E2E-020–025, BVA-010, DT-02 | existing-pom 121s + TTL-1 + merchants overlay | P0 |
| FR-S05 concurrent | E2E-030, API-020–022 | existing-pom cienko | P1 |
| FR-S06 CSRF | E2E-040–042, API-010–014, DT-01 | existing-pom happy/wrong/401 + kontrast merchant | P1 |
| FR-S07 guest | E2E-005, session-guest | existing-pom | P0 |
| FR-S08 no JWT storage | E2E-012, NET-104 | existing-pom | P0 |
| C-03 flag off | API-001–007, E2E-003, DT-05 | existing-it Spring; FE/BFF existing-pom `mirror-lab-flag-off` (csrf + statements 404) | P0 |

## Visual

| Wymaganie | ID | Pokrycie | Prio |
|---|---|---|---|
| FR-V01 page | E2E-100 | existing-pom | P0 |
| FR-V02 tiles | VIS-001–006, E2E-110 | existing-pom | P0 |
| FR-V03 dark | VIS-020/021 | existing-pom tile; designed colorScheme | P1 |
| FR-V04 full+mask | VIS-010 | designed | P1 |
| FR-V05 break | VIS-040 | existing-pom tagged | P1 |
...
| Wymaganie | ID | Pokrycie | Prio |
|---|---|---|---|
| FR-N01 503-retry | NET-001/100, E2E-200/201, API-150–152 | existing-pom 503→200 + TTL reset | P0 |
| FR-N02 abort/offline | NET-002/102, E2E-210/211 | designed abort; existing-pom setOffline `error-state` | P0 |
| FR-N03 lie | NET-003, E2E-220, UC-02 | existing-pom UI; designed fulfillment oracle | P0 |
| FR-N04 strip headers | NET-004/005 | designed | P1 |
| FR-N05 HAR | NET-006/103, E2E-230 | existing-pom fixture | P1 |
| FR-N06 CORS creds | API-140/141, EP-212 | existing-pom | P1 |
...
| FR-P05 iframe | E2E-320/321, NET-010, UC-03 | existing-pom live `frameLocator` Approve | P1 |
...
| FR-B02 statements | API-210–213, E2E-410–412, NET-008, EP-301 | existing-pom CSV + live PDF `%PDF-` | P1 |
...
| C-08 iframe same-origin | E2E-320 | existing-pom |
...
| PDF BFF as text | API-212, E2E-411/412, EP-301 | existing-pom live `%PDF-`; mocked fulfill designed |
| Refund bez zmiany statusu | API-120/121, DT-07 | existing-ra |
| BFF ignoruje flagę | API-004–007, DT-05 | existing-pom statements/csrf 404 |
...
| 503 leak across tests | API-152, BVA-031 | existing-pom `retry-window` |
