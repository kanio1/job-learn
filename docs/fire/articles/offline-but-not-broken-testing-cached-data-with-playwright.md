...
**URL:** https://www.thegreenreport.blog/articles/offline-but-not-broken-testing-cached-data-with-playwright/offline-but-not-broken-testing-cached-data-with-playwright.html
...
{
  "author": "Irfan Mujagic",
  "og:title": "The Green Report | Offline but Not Broken: Testing Cached Data with Playwright",
  "og:description": "A blog dedicated to Quality Assurance in Software Engineering",
  "sourceURL": "https://www.thegreenreport.blog/articles/offline-but-not-broken-testing-cached-data-with-playwright/offline-but-not-broken-testing-cached-data-with-playwright.html",
  "statusCode": 200,
  "scrapeId": "019fb3cb-ea5e-73fa-a3e8-8e78d5282783"
}
```

---

Modern web applications are expected to work even when the network doesn't. Whether it's a flaky connection or complete offline mode, users should still see relevant content thanks to technologies like [Service Workers](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API) and the [Cache API](https://developer.mozilla.org/en-US/docs/Web/API/Cache). In this post, we'll walk through a simple demo app that uses cached data to stay functional offline, and show how to write automated [Playwright](https://playwright.dev/) tests to verify that behavior — including both success and failure scenarios.
...
To verify that our app displays cached data when offline, we'll walk through a Playwright test that simulates a typical user journey: visiting the site online, caching the content, and revisiting it later without a network connection. Let's break down the test step by step.
...
You can find the full source code and demo application on our [GitHub repository](https://github.com/Crypted39/the-green-report-examples/tree/master/offline-but-not-broken-testing-cached-data-with-playwright). Until next time!
